...
#[macro_export]
macro_rules! supports_nitrous_conversion {
    ($TypeName:ty, $Unit:path, $Name:ident, [$($Units:path),*]) => {};
    ($TypeName:ty, $Name:ident, $ClassN:path, $ClassD:path, ($($UnitsN:path),*), $UnitsD:tt ) => {};
}
